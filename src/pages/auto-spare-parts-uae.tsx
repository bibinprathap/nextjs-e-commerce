...
function Page() {
    ...
    const burl = require(`../../images/posts/auto-spare-parts-uae.jpg`);
    return (
        <React.Fragment>
            <NextSeo 
                title='Widerange Of Auto Spare Parts Uae Bring From The Global In Short Period *Available Now'
                description='Promising To The Largest Online Supply Of Genuine Auto Spare Parts UAE  From The Global In Short Period With Your Request.'
            />
            <div className="block post-view">
                ...
                >
                    ...
                    <div className="post-header__body">
                        ...
                        <h1 className="post-header__title">Widerange Of Auto Spare Parts Uae Bring From The Global In Short Period *Available Now</h1>
                    ...
                    <div className="post-view__body">
                        ...
                        <div className={rootClasses}  >
                            <div className="post-view__card post">
                                ...
                                <p>
                                    we can deliver auto spare parts from the UAE to any city in the world.
                                
                    
                                    <AppLink href="/"> Spare parts </AppLink> are parts that you can buy separately to replace old or broken parts in a piece of equipment.
                                          
                     They are usually parts that are designed to be easily removed or fitted.In the future the machines will need spare parts and maintenance. Our Mission is to provide high quality genuine parts to our customers at the lowest prices, which makes us one of the top players in the Autospare parts dealerships in Dubai.  </p>  
                      <blockquote>
                                        <p>
                                        Promising to the largest online supply of genuine auto spare parts from the uae global in short period with your request.
                        </p>
                                        <p><cite>Abu dhabi,Dubai, UAE</cite></p>
                                    </blockquote>
                                    <p>
                                    Study packaging and fast shipping is one of our best quality. Our auto parts are delivered intact and on time. Each spare part is packaged in heavy cardboard and sent out immediately after payment is made.We have specialized in aftermarket body parts for a wide range of vehicles. We guarantees high-quality car parts at very attractive prices. 
                                    </p>
                                    <p>
                    ...
                    {dataBlogComments.count}
                                ...
                                <div className="post-view__card-body comments-view">
                                    <CommentsList
                                        ...
                                        comments={dataBlogComments.items5}
                                    />
