...
function Page() {
    ...
    const burl = require(`../../images/posts/rolls-royce-car-parts.jpg`);
    return (
        <React.Fragment>
            <NextSeo
                title='rolls royce car parts|catalog|near me|dubai,abudhabi,sharjah,Ras Al Khaimah.HURRY UP!'
                description='The company"s online catalogue contains well-researched content for better purchase OF ROLLS ROYCE SPARE PARTS IN UAE AND ALL OVER THE WORLD...'
            />
            <div className="block post-view">
                ...
                >
                    ...
                    <div className="post-header__body">
                        ...
                        <h1 className="post-header__title">Rolls Royce Car Parts Near Me At Low Price</h1>
                        ...
                        <div className={rootClasses}  >
                            <div className="post-view__card post">
                                <div className="post__body typography">
                                    <p> Rolls-Royce  Is A Legendary Maker Of Some Of The Best Luxury Cars You Can Ever Seen. Rolls-Royce Motor Cars Is The World'S Most Exclusive Manufacturer Of Luxury Automobiles. Rolls-Royce Cars Have Long Been The Pride Possession Of The Rich And Famous, And The Envy Of All Others. </p>
                                    <p>  The Development Of Rolls Royce Car Parts  And Accessories Continuously Evolves So They Are Optimally Configured For Each Model. Across The Range, The Quality And Utility Is Proven To Give You The Most Optimum Reliability From Your Rolls Royce..So You Can Be Assured That When Your Car Is In For Service, Maintenance Or Repair, Not Only Is It In The Safe Hands Of Experts Who Have Genuine Knowledge Of Everything That Has To Do With Your Car – You Can Count On Lasting Quality And A Perfect Fit Every Time.</p>
                                    <p>
                                        <strong>ROLLS ROYCE Spare Parts:</strong>
                                        {' '}
