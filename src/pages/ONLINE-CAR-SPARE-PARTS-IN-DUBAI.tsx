...
function Page() {
    ...
    const burl = require(`../../images/posts/online–car-parts-dubai.jpg`);
    return (
        <React.Fragment>
            <NextSeo
                title='Online Car Spare Parts In Dubai'
                description='Royal Auto Parts Market Provided Huge Quantity Of Car Spare Parts In Dubai And All Over The World. You Can Get Your Spare Parts On Your Home By Just Few Clicks Online.'
            />
            <div className="block post-view">
                ...
                >
                    ...
                    <div className="post-header__body">
                        ...
                        <h1 className="post-header__title">ONLINE CAR SPARE PARTS IN DUBAI</h1>
                        ...
                        <div className={rootClasses}  >
                            <div className="post-view__card post">
                                <div className="post__body typography">
                                    <p>
                                        Royal Auto Parts Market Provided Huge Quantity Of Car Spare Parts In Dubai And All Over The World.
                                        You Can Get Your Spare Parts On Your Home By Just Few Clicks Online.
                    </p>
                                    <p>
                                        After Getting <AppLink href="/contact-us-v1"> Inquiry </AppLink>From Customers
                    </p>
                                    <p>   Auto Spar Parts Market Will Forward This Inquiry To Morethan 10 Leading Spare Parts Suppliers In Uae </p>   <blockquote>
                                        <p>
                                            Customers Get Quotation From This Suppliers
                        </p>
                                        <p>You Can Choose Suppliers Who Give Better Product In Cheep Price And Fast Delivery</p>
                                    </blockquote>
