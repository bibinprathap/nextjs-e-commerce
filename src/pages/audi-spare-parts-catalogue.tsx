...
function Page() {
    ...
    const burl = require(`../../images/posts/audi-spare-parts-catalogue.jpg`);
    return (
        <React.Fragment>
            <NextSeo
                title='Audi Royal Auto Parts Market Dubai Genuine  Audi Car  Catalogue Click Now'
                description='Shop over 10000 Audi & VW parts in stock for same-day shipment. Use our extensive online catalog to find the Genuine parts you need fast in royal spare parts market.'
            />
            <div className="block post-view">
                ...
                >
                    ...
                    <div className="post-header__body">
                        ...
                        <h1 className="post-header__title">Audi Royal Auto Parts Market Dubai Genuine  Audi Car  Catalogue Click Now</h1>
                        ...
                        <div className={rootClasses}  >
                            <div className="post-view__card post">
                                <div className="post__body typography">
                                    <p>
                                        Shop over 10000 Audi & VW parts in stock for same-day shipment. Use our extensive online catalog to find the Genuine parts you need fast in royal spare parts market.
                </p>
                                    <p> Royal Auto parts Market receives an array of daily parts requests, but common inquiries we receive are Indiana drivers who are looking to replace. These are the main Audi spare parts our company issued,</p>
                                    <ul>
                    ...
                    {dataBlogComments.count}
                                ...
                                <div className="post-view__card-body comments-view">
                                    <CommentsList
                                        ...
                                        comments={dataBlogComments.items7}
                                    />
