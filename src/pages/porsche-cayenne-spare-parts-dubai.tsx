...
function Page() {
    ...
    const burl = require(`../../images/posts/porsche–cayenne-spare-parts–dubai.png`);
    return (
        <React.Fragment>
            <NextSeo
                title='Top Porsche Cayenne Spare Parts Uae- Abudhabi- Dubai.HURRY UP!'
                description='The Porsche Cayenne is a mid-size very good  luxury crossover sport utility car manufactured by the German manufacturer Porsche.'
            />
            <div className="block post-view">
                ...
                >
                    ...
                    <div className="post-header__body">
                        ...
                        <h1 className="post-header__title">Top Porsche Cayenne Spare Parts Uae- Abudhabi- Dubai</h1>
                        ...
                        <div className={rootClasses}  >
                            <div className="post-view__card post">
                                <div className="post__body typography">
                                    <p>
                                        The Porsche Cayenne is a mid-size very good  luxury crossover sport utility car manufactured by the German manufacturer Porsche. Our company Royal Auto parts Market provided 100 % genuine spare parts product of Porsche cayenne all over uae in discount rate.</p>
                                    <p> we provided 100% quality product of Porsche cayenne in your home.Royal Auto parts Market promising to the largest online supply of genuine Porsche cayenne auto spare parts from the UAE global in short period. At your request get inquiry from the customers. Auto Royal Auto parts Market will forward this enquiry more than 10 leading spare parts suppliers of Porsche cayenne in UAE. Customers get quotation from these suppliers. You can choose suppliers who give better product of Porsche in cheap price and fast delivery. We can deliver spare parts of Porsche from the UAE to any city in the world.</p>
                                    <p>We are happy to say that our employees are proud to work for Porsche. They are driven by their passion for our extraordinary products. This motivates our employees to search constantly for improvements, regularly reviewing and deliver your product at right time.</p>
                                    <p>
                                        <strong>Porsche Cayenne Spare Parts:</strong>
                                        {' '}
                                        <AppLink href="/catalog/products?make=PO&makeCode=PORSCHE&origin=ORIGINAL&origincode=OE">Hot Offers</AppLink>
                                    </p>
                    ...
                    {dataBlogComments.count}
                                ...
                                <div className="post-view__card-body comments-view">
                                    <CommentsList
                                        ...
                                        comments={dataBlogComments.items6}
                                    />
