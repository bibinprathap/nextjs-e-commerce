...
function Page() {
    ...
    const burl = require(`../../images/posts/MERCEDES-BENZ-SPARE-PARTS-UAE.jpg`);
    return (
        <React.Fragment>
            <NextSeo
                title='Mercedes Benz Spare Parts Uae $ All Over The World Online HURRY UP'
                description='Royal Spare Parts Market, We Provide A Conclusive Range Of Mercedes Parts That Are Shipped Here With An Orginal Quality Mark And Model Factory Bind From Many Approve Factories All.'
            />
            <div className="block post-view">
                ...
                >
                    ...
                    <div className="post-header__body">
                        ...
                        <h1 className="post-header__title">Mercedes Benz Spare Parts Uae$All Over The World Online HURRY UP</h1>
                        ...
                        <div className={rootClasses}  >
                            <div className="post-view__card post">
                                <div className="post__body typography">
                                    <p>
                                        Royal spare parts market, we provide a conclusive range of Mercedes parts that are shipped here with an orginal quality mark and model factory bind from many approve factories all. Royal Auto parts Market promising to the largest online supplier of genuine Porsche cayenne auto spare parts from the UAE global in a short period. At your request get inquiries from the customers. Royal Auto parts Market will forward this inquiry to more than 10 leading spare parts suppliers of Porsche cayenne in UAE. Customers get quotations from these suppliers. Mercedes is a international automobile marque and a distribution of the German company Daimler AG. The brand is known for richness vehicles, buses, coaches, and lorries…
                </p>
                                    <p>  Our company supplier’s different parts of  Royal Auto parts Market would like to welcome all fans to the source for online Mercedes parts and Mercedes Benz auto parts. For different quality OEM, aftermarket  Mercedes accessories, and  Mercedes parts all at low prices. Whether you’re looking for a broad selection of characteristic  Mercedes rims, Mercedes accessories, or use to bring back your classic Mercedes Benz to its earlier standard of replacement Mercedes Benz spare parts, we have even the immense Mercedes Benz spare parts, all at the least prices. </p>
                                    <p>
                                        <strong>Mercedes Benz Spare Parts:</strong>
                                        {' '}
                                        <AppLink href="/catalog/products?make=MB&makeCode=MERCEDES+BENZ&origin=ORIGINAL&origincode=OE">Hot Offers</AppLink>
                                    </p>
                    ...
                    {dataBlogComments.count}
                                ...
                                <div className="post-view__card-body comments-view">
                                    <CommentsList
                                        ...
                                        comments={dataBlogComments.items10}
                                    />
