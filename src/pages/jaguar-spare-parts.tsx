...
function Page() {
    ...
    const burl = require(`../../images/posts/jaguar-spare-parts.png`);
    return (
        <React.Fragment>
            <NextSeo
                title='jaguar spare parts|xtype|breake|near me| uae|dubai|abudhabi'
                description='Find the cheapest second hand Jaguar X-Type spare parts for all models in one ... Our supplier"s locations are in over the UAE including Dubai, Abu Dhabi, sharjah,Ras Al Khaimah'
            />
            <div className="block post-view">
                ...
                >
                    ...
                    <div className="post-header__body">
                        ...
                        <h1 className="post-header__title">A Wide Selection Of Jaguar Spare Parts From Dubai To Help Ensure A Smooth Drive.HURRY UP!</h1>
                        ...
                        <div className={rootClasses}  >
                            <div className="post-view__card post">
                                <div className="post__body typography">
                                    <p>
                                        Find the cheapest second hand Jaguar X-Type spare parts for all models in one ... Our suppliers' locations are in over the UAE including Dubai, Abu Dhabi, sharjah,Ras Al Khaimah and all over the world. The development of Genuine jaguar Spare Parts and Accessories continuously evolves so they are optimally configured for each model.  </p>
                                    <p>
                                        <strong>Jaguar Spare Parts:</strong>
                                        {' '}
                                        <AppLink href="/catalog/products?filter_make=JAGUAR&filter_makeCode=JAGUAR&filter_origin=ORIGINAL&filter_origincode=OE">Hot Offers</AppLink>
                                    </p>
                    ...
                    {dataBlogComments.count}
                                ...
                                <div className="post-view__card-body comments-view">
                                    <CommentsList
                                        ...
                                        comments={dataBlogComments.items11}
                                    />
