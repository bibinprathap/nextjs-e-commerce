...
function Page() {
    ...
    const post = dataBlogPosts[2];
    // const burl = require(post.image);
    const burl = require(`../../images/posts/car-accessories-in-sharjah-dubai.jpg`);
                    ...
                    <div className="post-header__body">
                        ...
                        <div className="post-header__meta">
                            <ul className="post-header__meta-list">
                                ...
                                <li className="post-header__meta-item">{post.date}</li>
                                <li className="post-header__meta-item">
                                    <AppLink href="/" className="post-header__meta-link">
                                        0 Comments
                                    </AppLink>
